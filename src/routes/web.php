...
Route::namespace('Core\Common\User\Auth\Presentation\Actions')->middleware('guest')->group(
    function (): void {
...
// Route::namespace('Core\Common\Admin\Account\User\Presentation\Actions\Web')->group(function (): void {
//     Route::prefix('admin')->name('admin.')->middleware('auth')->group(function(): void {
//         Route::get('/users', IndexAction::class)->name('users.index');
//     });
// });
